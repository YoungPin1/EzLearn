...
Перед началом проекта я поставил перед собой цель написать удобное приложение для изучения
новых слов и терминов, предназначенное для студентов или школьников. В процессе разработки
я столкнулся со многими проьблемами, но мне удалось их решить. Конечный функционал приложения стал
даже больше задуманного, предоставляя конечному пользователю полную свободу действий и максимальное
